...
Colors come from the shared diverging ramp (0 = the page ground, so a zero cell
recedes in either theme), so this page is a
witness for the **Canvas2D-vs-WebGL2 pixel-identity gate** -- `run-gate.sh`.
